...
import (
	...
	"encoding/json"
	"fmt"
	"github.com/LukeHagar/terraform-provider-PlexAPI/internal/sdk/internal/globals"
...
func New(opts ...SDKOption) *PlexAPI {
	sdk := &PlexAPI{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.0.1",
			GenVersion:        "2.338.12",
			UserAgent:         "speakeasy-sdk/go 0.0.1 2.338.12 0.0.3 github.com/LukeHagar/terraform-provider-PlexAPI/internal/sdk",
			Globals:           globals.Globals{},
			ServerDefaults: []map[string]string{
				{
					"protocol": "http",
