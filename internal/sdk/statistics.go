...
func (s *Statistics) GetResourcesStatistics(ctx context.Context, request operations.GetResourcesStatisticsRequest) (*operations.GetResourcesStatisticsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	case httpRes.StatusCode == 401:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.GetResourcesStatisticsStatisticsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Statistics) GetBandwidthStatistics(ctx context.Context, request operations.GetBandwidthStatisticsRequest) (*operations.GetBandwidthStatisticsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	case httpRes.StatusCode == 401:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.GetBandwidthStatisticsStatisticsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
